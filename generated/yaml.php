 ...
 *
 */
function yaml_parse_file($filename, $pos = 0, int &$ndocs = null, array $callbacks = null)
{
 ...
 *
 * @param $url url should be of the form "scheme://...". PHP
 ...
 *
 */
function yaml_parse_url($url, $pos = 0, int &$ndocs = null, array $callbacks = null)
{
 ...
 *
 */
function yaml_parse($input, $pos = 0, int &$ndocs = null, array $callbacks = null)
{
